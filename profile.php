...
$sqlpro = "SELECT * FROM profs WHERE uname='$prof_user';";
$res = mysqli_query($conn, $sqlpro);
$row = mysqli_fetch_array($res);
$photo = $row['profpic']; //path to profile picture
?>
    ...
    <div class="h-50 center-me text-center">
        <div class="my-auto">
            ...
            <form action="includes/upload-helper.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <button type="submit" name="prof-submit" class="btn btn-outline-success btn-lg">upload</button>
                </div>
